...
<legend><h3>Our Skills</h3></legend>
    ...
    <div class="tab-content">
        <div id="HTML" class="tab-pane active">
            <p>Different HTML works</p>
        </div>
        <div id="CSS" class="tab-pane">
            <p>Different CSS works</p>
        </div>
